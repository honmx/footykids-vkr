...
import UploadPlaceImageModal from "../Modals/UploadPlaceImageModal";
...
const OpenOrUploadPlaceImageWrapper: FC<Props> = ({ image, placeId, view = true, upload = false, requestFn, closeOuterModal, children }) => {
  ...
  return (
    <>
      ...
      {
        typeof document !== "undefined" && upload && placeId && requestFn &&
        createPortal(
...
export default OpenOrUploadPlaceImageWrapper;